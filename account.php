...
//check if the session variables are set or merong laman ang sssion variables or naga exist sila
//this is to check if naka log in pa yung account or hindi man
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="px-4 py-3">
                ...
                <div class="p-4 rounded shadow-sm bg-light">
                    <p class="font-italic mb-0">Manage Business</p>
                    <p class="font-italic mb-0">Time Management</p>
                    <p class="font-italic mb-0">Photographer/Video Editing</p>
                </div>
            </div>
